...
func sendActualInvitation(ctx context.Context, s sender.Sender, invite *core.UserInvitation, user *core.User, to string) error {
	...
	Welcome to gogo-cli-example! Please follow the link to set up your account.

	%s`, link),
		Html: fmt.Sprintf(`
	<p>Hi!</p>

	<p>Welcome to gogo-cli-example! Please follow the link to set up your account.</p>
